    ...
    if (token) {
      const fetchUserData = async () => {
        try {
          ...
          console.log("Usuario logueado Nav:", loggedInUser);
        } catch (error) {
          console.log(error);
        }
      };
              ...
              <Dialog.Panel className="relative flex w-full max-w-xs flex-col overflow-y-auto bg-white pb-12 shadow-xl">
                ...
                <div className="border-t border-gray-200 px-4 py-6">
                  <a href="#iiii" className="-m-2 flex items-center p-2">
                    <img src="/img/col.svg" alt="" className="block h-auto w-5 flex-shrink-0" />
            ...
            <div className="flex h-16 items-center">
              ...
              <div className="ml-4 flex lg:ml-0">
                <a href="/">
                  ...
                  <img className="mt-3 h-[200px] w-[200px] mb-12" src="/img/2.svg" alt="banana" />
                </a>
              </div>
