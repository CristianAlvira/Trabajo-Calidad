...
export const EliminarEvaluacionModal = ({ onClose, evaluacionId, actualizarEvaluaciones }) => {
  ...
  const handleEliminarEvaluacion = () => {
    ...
    axios
      ...
      .then((response) => {
        ...
        actualizarEvaluaciones(); // Actualiza el estado de las opiniones en el componente padre
        onClose();
      })
      .catch((error) => {
        console.error("Error al eliminar la evaluación:", error);
        setError("Error al eliminar la evaluación. Por favor, inténtalo de nuevo.");
      });
  };
  return (
                ...
                <div className="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                  ...
                  <div className="mt-2">
                    <p className="text-sm text-gray-500">
                      ¿Estás seguro de que deseas eliminar esta evaluación? Esta acción no se puede
                      deshacer.
                    </p>
                  </div>
                </div>
